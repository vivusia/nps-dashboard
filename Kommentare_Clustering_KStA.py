...
# DATEIEN EINLESEN
# -------------------------
folder_path = r"C:\Users\viviane.lorenc\OneDrive - DuMont Systems GmbH & Co. KG\Dokumente - Teamkanal\PowerBI\NPS\Cleverpush Antworten\KStA"
...
# SPALTEN PRÜFEN
# -------------------------
text_col = "answer_jm7ee"    # Kommentar
score_col = "answer_acRYu"   # NPS-Wert
...
def classify_comment(comment_text):
    ...
    try:
        ...
        print(f"⚠️ Fehler bei Text: {comment_text[:50]}... {e}")
...
# EXPORTIEREN
# -------------------------
output_path = r"C:\Users\viviane.lorenc\OneDrive - DuMont Systems GmbH & Co. KG\Dokumente - Teamkanal\PowerBI\NPS\Python Skripts\Kommentare Clustering\Kommentare_Clustering_KStA.xlsx"
